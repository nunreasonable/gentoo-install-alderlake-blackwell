...
| Suite de testes do host | 10 grupos, **571 asercoes**, exit 0 |
...
| | |
|---|---|
| Base | **Alta** — tres ciclos QEMU + boot e um bare metal + boot, 571 asercoes. Nenhuma execucao limpa com o codigo atual |
